...
public:
	...
	/*!
	 *  \brief 创建AVI文件
	 *  \param [in]	char * strFileName	文件名
	 *  \param [in]	double framesPerSecondPlayback	视频播放帧率fps
	 *  \retval  如果成功返回0
	 */
	...
	/*!
	 *  \brief 设置压缩参数
	 *  \param [in]	MVImage * pImage 图像指针
	 *  \param [in]	AVICOMPRESSOPTIONS * opts	压缩参数。可以为NULL
	 *  \param [in]	bool ShowDialog	是否显示压缩参数设置对话框
	 *  \param [in]	HWND hparent	如果显示压缩参数设置对话框，给出父窗口句柄。否则可以为NULL
	 *  \retval  如果成功返回0
	 */
