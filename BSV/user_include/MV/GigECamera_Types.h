...
*/
typedef enum {	
	PixelFormat_Mono8,	//!<8Bit灰度
	PixelFormat_BayerBG8,	//!<8Bit Bayer图,颜色模式为BGGR
	PixelFormat_BayerRG8,	//!<8Bit Bayer图,颜色模式为RGGB
	PixelFormat_BayerGB8,	//!<8Bit Bayer图,颜色模式为GBRG
	PixelFormat_BayerGR8,	//!<8Bit Bayer图,颜色模式为GRBG
