================================================================================
MICROSOFT 基础类库: BSV 项目概述
===============================================================================

应用程序向导已为您创建了这个 BSV 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。

本文件概要介绍组成 BSV 应用程序的每个文件的内容。
...
BSV.h
这是应用程序的主要头文件。它包括其他项目特定的头文件(包括 Resource.h)，并声明 CBSVApp 应用程序类。

BSV.cpp
这是包含应用程序类 CBSVApp 的主要应用程序源文件。

BSV.rc
这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源位于 2052 中。

res\BSV.ico
这是用作应用程序图标的图标文件。此图标包括在主要资源文件 BSV.rc 中。
...
BSVDlg.h，BSVDlg.cpp - 对话框
这些文件包含 CBSVDlg 类。该类定义应用程序主对话框的行为。该对话框的模板位于 BSV.rc 中，该文件可以在 Microsoft Visual C++ 中进行编辑。
...
StdAfx.h，StdAfx.cpp
这些文件用于生成名为 BSV.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
